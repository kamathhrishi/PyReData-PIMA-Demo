...
from PyRData import Generator
from PyRData import Plots
from PyRData import Components
...
File='pima-indians-diabetes-database\diabetes.csv'
...
Pg1=Page(App1,style='background:rgb(160, 159, 139);')
Pg1.AddDiv("Wrapper",style="border:1px solid black;width:1400px;border-radius:15px;background:white;margin-left:285px;padding-left:50px;")
...
Pg1.AddDiv("Abstract",Div="Wrapper",style="background:rgb(235, 235, 224);padding:10px;width:1250px;",centerize=True)
Pg1.Header('h3','<u>Abstract</u>',Div='Abstract',centerize=True,style="margin-right:10px")
Pg1.AddText('''The population for this study was the Pima Indian population near
...
longitudinal manner.
''',Div="Abstract",style="text-align:justify;margin:20px;")
Pg1.AddBreak(Div='Wrapper')
Pg1.AddImg('PIMA.png',Div="Wrapper",centerize=True,style="height:250px;width:400px;border-radius:10px;")
Pg1.AddBreak(Div='Wrapper')
Attributes=["<b>Pregnancies:</b> Number of times pregnant",
...
Pg1.AddTable(Data.head(n=5),Div="Wrapper",Header_Style="border:1px solid black;" , style="border:1px solid black;",centerize=True,Row_Style="border:1px solid black;",Col_Style="border:1px solid black;")
Pg1.AddBreak(Div='Wrapper')
Pg1.Header('h2','Visualizations',Div="Data Stats",centerize=True)
Pg1.Header('h2','<u><b>Distribution of Variables</b></u>',Div='Wrapper',centerize=True)
Pg1.Header('h3','Positive Outcomes',Div='Wrapper',style="margin-right:800px" ,centerize=False)
PL=Plots(Pg1)
PL.RenderPlot
...
Pg1.Header('h3','Negative Outcomes',Div='Wrapper',style="margin-right:800px" ,centerize=False)
