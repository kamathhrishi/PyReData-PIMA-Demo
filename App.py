...
Pg1.Header('h4','Positive Outcomes',Div='Wrapper',style="margin-right:800px" ,centerize=False)
PL=Plots(Pg1)
PL.RenderPlot
...
Pg1.Header('h4','Negative Outcomes',Div='Wrapper',style="margin-right:800px" ,centerize=False)
