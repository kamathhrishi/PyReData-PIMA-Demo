...
Pg1=Page(App1,style='background:rgb(236, 236, 221);')

St=Stylesheet(Pg1)
St.CreateStyleSheet(Name="Custom")


Pg1.AddDiv("Wrapper",style="border:1px solid black;width:1400px;background:white;margin-left:120px;padding-left:50px;")
